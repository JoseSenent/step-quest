...
import enemyImage from "../assets/images/worm.png";

import tutorialImage from "../assets/images/tutorial-bombas.jpg";
...
const PLAYER_SPEED = 1999; // Determina la frecuencia de ataque del jugador
            ...
            >
              ...
              <div className="relative">
                <img
                  src={enemyImage}
                  alt="ladybug enemy"
                  className="enemy w-24 scale-x-[-1]"
                />
          ...
          <div className="absolute inset-0 z-[1000] flex items-center justify-center bg-black px-4">
            <div className="w-full rounded-xl border-4 border-[#5D7E9A] bg-[#f5f7fa] pb-6 shadow-[0px_0px_0px_3px_#1F2732]">
              ...
              <p className="mt-4 px-4 text-center font-medium text-[#1f2732]">
                Si la burbuja tiene un{" "}
                <span className="font-bold">tono oscuro</span> tendrás que tocar
                hasta llegar a <span className="text-red-500">1</span>.
              </p>

              <p className="mt-2 px-4 text-center font-medium text-pretty text-[#1f2732]">
                ¡Ten cuidado! Si llegas a{" "}
                <span className="text-red-500">0</span> entonces{" "}
                <span className="font-bold">perderás una exclamación</span>.
              </p>
