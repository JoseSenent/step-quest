...
import enemyImage from "../assets/images/mushroom.png";

import tutorialImage from "../assets/images/tutorial-escalonadas.jpg";
...
const ENEMY_MAX_HEALTH = 225; // Salud máxima del oponente
...
const PLAYER_SPEED = 2125; // Determina la frecuencia de ataque del jugador
...
const ENEMY_CRITICAL = 0.33; // Probabilidad de golpe crítico del oponente
            ...
            >
              ...
              <div className="relative">
                <img
                  src={enemyImage}
                  alt="ladybug enemy"
                  className="enemy w-14 scale-x-[-1]"
                />
          ...
          <div className="absolute inset-0 z-[1000] flex items-center justify-center bg-black px-4">
            <div className="w-full rounded-xl border-4 border-[#5D7E9A] bg-[#f5f7fa] pb-6 shadow-[0px_0px_0px_3px_#1F2732]">
              ...
              <p className="mt-4 px-4 text-center font-medium text-[#1f2732]">
                Si una burbuja tiene un{" "}
                <span className="font-bold">número</span>, tienes que tocarla
                tantas veces como indique la{" "}
                <span className="font-bold">cifra</span>.
              </p>

              <p className="mt-2 px-4 text-center font-medium text-pretty text-[#1f2732]">
                ¡Solo obtendrás la{" "}
                <span className="font-bold">exclamación</span> si consigues
                llegar a <span className="text-red-500">0</span>!
              </p>
