...
import tutorialImage1 from "./assets/images/tutorial-1.jpg";
import tutorialImage2 from "./assets/images/tutorial-2.jpg";
import tutorialImage3 from "./assets/images/tutorial-3.jpg";
...
const ENEMY_MAX_HEALTH = 300; // Salud máxima del oponente
const PLAYER_DAMAGE = 10; // Determina el daño que inflige el jugador
const ENEMY_DAMAGE = 12; // Determina el daño que ocasiona el oponente
const PLAYER_SPEED = 2500; // Determina la frecuencia de ataque del jugador
...
export default function App() {
  ...
  const [tutorial, setTutorial] = useState(3);
  ...
  function applyAllExclamations() {
    ...
    function exclamationCounterAnimation() {
      if (exclamationAccRef.current === 0) return;
      return createTimeline({
        onBegin: () => (exclamationAccRef.current = 0),
      })
        .add(".exclamation-counter", {
          scale: 0.7,
          duration: 100,
        ...
        startTimeoutRef.current = setTimeout(() => {
          ...
          endTimeoutRef.current = setTimeout(() => {
            ...
            if (
              ...
              isExclamationTouched.current &&
              (renderExclamation as number) - 1 === 1
            ) {
      ...
      <div className="relative flex h-[100dvh] w-[392px] flex-col overflow-hidden rounded-2xl border-4 border-slate-600">
        ...
        <div className="grid flex-[0.55] grid-cols-1 grid-rows-1 items-center justify-between bg-[url(src/assets/images/battleback.webp)] bg-cover bg-no-repeat px-1">
          ...
          <div className="mb-4 flex w-full flex-col self-end">
            ...
            <div
              ...
              className="relative mx-4 flex justify-between px-4 pt-12 pb-2"
            >
              {/* EXCLAMACIÓN */}
              ...
              <div className="relative">
                <img
                  src={ladybugImage}
                  alt="ladybug enemy"
                  className="enemy size-18 scale-x-[-1]"
                />
          ...
          <div className="absolute inset-0 z-[1000] flex items-center justify-center bg-white/50 px-4">
            <div className="w-full rounded-xl border-4 border-[#5D7E9A] bg-[#f5f7fa] pb-6 shadow-[0px_0px_0px_3px_#1F2732]">
              ...
              <div className="mx-4 mt-6">
                <button className="btn-text-stroke w-full cursor-pointer rounded-full border-2 border-[#345] bg-[#496580] py-1 text-lg font-semibold text-[#f5f7fa] shadow-[inset_1px_1px_4px_0px_#fff8,_inset_-1px_-1px_4px_0px_#0008] transition-all duration-150 active:scale-90 active:bg-[#5d7e9a]">
        ...
        {tutorial === 3 && (
          <div className="absolute inset-0 z-[1000] flex items-center justify-center bg-black px-4">
            <div className="w-full rounded-xl border-4 border-[#5D7E9A] bg-[#f5f7fa] pb-6 shadow-[0px_0px_0px_3px_#1F2732]">
              <p className="mx-6 -translate-y-1/2 rounded-full border-2 border-[#7D9AB3] bg-[#3C5168] py-1 text-center text-[1.325rem] font-bold tracking-wide text-[#f5f7fa] shadow-[0px_-3px_0px_0px_#1F2732,_inset_0px_0px_24px_2px_#1f2732cc]">
                Burbujas
              </p>
              ...
              <p className="mt-2 px-4 text-center leading-snug font-medium text-[#1f2732]">
                <span className="font-bold">Toca</span> una burbuja que contenga
                una exclamación «
                <span className="font-black text-red-500">!</span>», para
                guardarla.
              </p>

              <p className="mt-2 px-4 text-center font-medium text-[#1f2732]">
                Puedes acumular hasta{" "}
        ...
        {tutorial === 2 && (
          <div className="absolute inset-0 z-[1000] flex items-center justify-center bg-black px-4">
            <div className="w-full rounded-xl border-4 border-[#5D7E9A] bg-[#f5f7fa] pb-6 shadow-[0px_0px_0px_3px_#1F2732]">
              ...
              <p className="mt-2 px-4 text-center font-medium text-[#1f2732]">
                Si <span className="font-bold">no tocas</span> la burbuja a
                tiempo ¡
                <span className="font-bold">
                  perderás una <span className="text-red-500">exclamación</span>
                </span>
                !
              </p>

              <p className="mt-2 px-4 text-center font-medium text-[#1f2732]">
                Si logras tocar las exclamaciones de forma{" "}
                <span className="font-bold">consecutiva</span> aumentarás tu{" "}
                <span className="text-red-500_ font-bold">cadena</span>.
              </p>
        ...
        {tutorial === 1 && (
          <div className="absolute inset-0 z-[1000] flex items-center justify-center bg-black px-4">
            <div className="w-full rounded-xl border-4 border-[#5D7E9A] bg-[#f5f7fa] pb-6 shadow-[0px_0px_0px_3px_#1F2732]">
              ...
              <p className="mt-2 px-4 text-center font-medium text-[#1f2732]">
                Utiliza <span className="font-bold">todas</span> tus
                exclamaciones para realizar un{" "}
                <span className="font-bold text-red-400">golpe fuerte</span> o{" "}
                <span className="font-bold text-blue-400">defenderte</span>.
              </p>

              <p className="mt-2 px-4 text-center font-medium text-[#1f2732]">
                Cuantas <span className="font-bold">más</span> tuvieras
                acumuladas, <span className="font-bold">más poderosas</span>{" "}
                serán estas acciones.
              </p>
