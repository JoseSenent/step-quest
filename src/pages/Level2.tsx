...
import crabImage from "../assets/images/crab.png";

import tutorialImage from "../assets/images/tutorial-interrogaciones.jpg";
...
const ENEMY_MAX_HEALTH = 250; // Salud máxima del oponente
...
const ENEMY_CRITICAL = 0.12; // Probabilidad de golpe crítico del oponente
          ...
          <div className="absolute inset-0 z-[1000] flex items-center justify-center bg-black px-4">
            <div className="w-full rounded-xl border-4 border-[#5D7E9A] bg-[#f5f7fa] pb-6 shadow-[0px_0px_0px_3px_#1F2732]">
              ...
              <p className="mt-2 px-4 text-center font-medium text-[#1f2732]">
                Si una burbuja contiene una{" "}
                <span className="text-red-500">interrogación</span>, ¡tienes que{" "}
                <span className="font-bold">ignorarla</span>!
              </p>

              <p className="mt-2 px-4 text-center font-medium text-[#1f2732]">
                Si la tocas, ¡<span className="font-bold">perderás</span> una de
                tus exclamaciones y{" "}
                <span className="font-bold">se reiniciará</span> la cadena!
              </p>
